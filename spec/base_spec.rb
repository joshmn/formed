...
RSpec.describe Formed::Base do
  ...
  context "errors" do
    class FakeTwoForm < Formed::Base
      attribute :name

      validates :name, presence: true
    end

    class FakeOneForm < Formed::Base
      has_many :fake_twos
    end
  ...
  context "has many does not has_many itself" do
    class HasManyOneForm < Formed::Base
      has_many :has_many_two
    end

    class HasManyTwoForm < Formed::Base
    end
